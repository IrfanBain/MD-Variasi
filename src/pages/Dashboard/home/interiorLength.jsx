...
export default function InteriorLength() {
...
useEffect(() => {
    ...
    const q = query(productsRef, where("kategori", "==", "Interior"));
    ...
    return (
        <div className="flex flex-col bg-purple-600 w-32 lg:w-72  pt-2 lg:pt-5 rounded-md text-white">
